      ...
      .then((fb2Text) => {
        ...
        if (sections) {
          for (let i = 0; i < sections.length; i++) {
            ...
            const contentWithImages = chapterContent.replace(
              /<image l:href="#([^"]+)"\/>/g,
              (match, id) => {
      ...
      >
        <NavbarContent className="iwillwinnavbar">
          ...
          <NavbarContent>
            ...
            <div className="read-book-title">{title}</div>
            <div className="read-book-title">{progressText}</div>
          </NavbarContent>
          <NavbarContent className="iwlillwin-mini-box">
            <NavbarItem>
              <Button className="navbar-item" onClick={onContentModalOpen}>
      ...
      >
        ...
        >
          {loading ? (
            ...
            <div>
              <p className="chapter">{bookChapters[selectedChapter].title}</p>
              <p>
